  ...
  const team = [
    {
      ...
      name: "Samanvay Gupta",
      title: "CEO",
      desc: "Logical thinking, Bussiness minded",
      linkedin: "https://www.linkedin.com/in/samanvay-gupta/",
    ...
    },
    {
      ...
      name: "Nancy Kumari",
      title: "HR",
      desc: "Creative thinking, Strong constructive feedback",
      ...
      <div className="max-w-screen-xl mx-auto px-4 md:px-8">
        <div className="max-w-xl">
          ...
          <p className="text-gray-600 mt-3">
            A team that consist the combination of experts to handle hectic task
            and go beyond imagination.
          </p>
        </div>
        <div className="mt-12">
